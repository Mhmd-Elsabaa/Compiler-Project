    ...
    public partial class Form1 : Form
    {
        ...
        private void token_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < input.Length; i++)
            {
                ...
                {
                    output_txt.Text += tkn +" \t erorrrrrrrrr" + Environment.NewLine;
                    tt[index, 0] = tkn;
                    tt[index, 1] = "eror";
                    index++;
                    tkn = "";
            ...
            try
            {
                for (int i=0;i<index;)
                {
                    if (tt[i, 1] == "key_word")
                    {
                        ...
                        {
                            if (tt[i + 1, 1] == "identifier" || tt[i + 1, 1] == "number")
                            {
                        ...
                        else if (tt[i, 0] == "منطفي" || tt[i, 0] == "صحيح" || tt[i, 0] == "نصي")
                        {
                            if (tt[i + 1, 1] == "identifier")
                            {
                        ...
                        else if (tt[i, 0] == "اذا")
                        {
                            ...
                            if (tt[i + 1, 0] == "(" && tt[i + 3, 1] == "operator" &&  ( tt[i + 2, 1] == "number"|| tt[i + 2, 1] == "identifier")  && (tt[i + 4, 1] == "identifier" || tt[i + 4, 1] == "number") && tt[i + 5, 0] == ")" && tt[i + 6, 0] == "نفذ")                        
                            {
                                output_l_text.Text += "جمله شرطيه صحيحه" + Environment.NewLine;
                                i += 7;

                            }
                            else if(tt[i + 1, 0] == "(" && tt[i + 2, 1] == "identifier" && tt[i + 3, 0] == ")" && tt[i + 4, 0] == "نفذ")
                            {
                                output_l_text.Text += "جمله شرطيه صحيحه" + Environment.NewLine;
                                i += 5;
                            }
                        ...
                        else if (tt[i, 0] == "من")
                        {
                            ...
                            if (tt[i + 1, 1] == "identifier" && (tt[i + 2, 0] == "=" && tt[i + 3, 1] == "number") && (tt[i + 4, 0] == "حتي" && ( tt[i + 5, 1] == "number") || tt[i + 5, 1] == "identifier") && tt[i + 6, 0] == "خطوه")                     
                            {
                                output_l_text.Text += "جمله تكرار صحيحه" + Environment.NewLine;
                                i += 6;

                            }
                            else if ((tt[i + 1, 1] == "identifier" || tt[i + 1, 1] == "number") && tt[i + 2, 0] == "حتي" && (tt[i + 3, 1] == "identifier" || tt[i + 3, 1] == "number") && tt[i + 4, 0] == "خطوه")
                            {
                                output_l_text.Text += "جمله تكرار صحيحه" + Environment.NewLine;
                                i += 5;
                            }
                    ...
                    else if (tt[i, 1] == "operator")
                    {
                        if (tt[i, 0] == "=")
                        {
                            if ((tt[i + 1, 1] == "identifier" || tt[i + 1, 1] == "number") && (tt[i - 1, 1] == "identifier"))
                            {
                        ...
                        {
                            if ((tt[i + 1, 1] == "identifier" || tt[i + 1, 1] == "number") && (tt[i - 1, 1] == "identifier" || tt[i - 1, 1] == "number") && tt[i - 2, 0] == "="  && t == true)
                            {
                                i += 2;
                            }
                            else
